...
async def pingme(client: Client, message: Message):
    ...
    try:
       ...
       pass
    await xx.edit("**20% ♡︎♡︎♡︎♡︎♡︎♡︎♡︎♡︎ 🚩😈ᴘᴏɪsᴏɴ ᴏᴘ ʙᴏʟᴛᴇ🚩😈**")
    await xx.edit("**40% ❥︎❥︎❥︎❥︎❥︎❥︎❥︎❥︎❥︎ 🚩😈ᴊᴀɪ sʜʀᴇᴇ ʀᴀᴍ**")
    await xx.edit("**60% ❣︎❣︎❣︎❣︎❣︎❣︎❣︎❣︎❣︎❣︎❣︎ 🚩😈ʀᴀᴅʜᴇ ᴋʀɪsʜɴᴀ**")
    await xx.edit("**80% ♕︎♕︎♕︎♕︎♕︎♕︎♕︎♕︎♕︎ 🚩😈Hᴀʀ ʜᴀʀ ᴍᴀʜᴀᴅᴇᴠ**")
    await xx.edit("**100% 𖤍𖤍𖤍𖤍𖤍𖤍𖤍𖤍 🚩Jᴀɪ sʜʀᴇᴇ ʀᴀᴍ🚩**")
    end = datetime.now()
